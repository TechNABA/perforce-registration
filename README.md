...
The Worker ships with a test suite covering routing, authentication, validation, storage, and pagination. It runs against an in-memory store, so it needs no credentials and touches nothing live:
